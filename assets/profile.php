...
<body class="loading">
					...
					<div class="header-nav">
						<ul class="scroll-to-tab">
							<b class="col-xs-2">
								<li class="active">
								    <!--***ENLACE ROTO***-->
									<!-- <a href="/index1.php/#manual-tab" onclick="openNavArea('manual'); closeNav()" class="a-nav-button" aria-controls="manual-tab" role="tab" data-toggle="tab" aria-expanded="true">
								...
								<li class="header-profile" onclick="toggleProfile()">
									<div class="dropdown" id="perfil">
										...
										<div class="dropdown-menu" aria-labelledby="dropdownPerfil">
											<a class="dropdown-item no-scroll" href="../profile">
												<img src="dna/img/icono/userinfo.webp" />
												<div class="dropdown-profile-text">
													<p class="profile-user-name bold"><?php echo $_SESSION['usuario'];?></p>
											...
											<a class="dropdown-item logout-item no-scroll" href="login.php" class="btn btn-primary btn-sm" id="logout">
			...
			<div class="modal-content">
				<form action="../send.php" method="post">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="modal-found-a-job-label">Encontré Trabajo</h4>
					</div>
					<div class="modal-body">
						<p>Felicidades! Es hora de asumir un nuevo desafío!</p>
						<p>Outplacement lo felicita!</p>
						<p>Ayúdenos a entender sobre este paso en su carrera contestando a las siguientes preguntas:</p>
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label" for="working-through_genes">
										<i class="fa"></i>
										Encontró la posición a través de IBjobcoach? </label>
									<div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label" for="working-recommend_dna">
										<i class="fa"></i>
										Recomendaría IBjobcoach a sus contactos? </label>
									<div>
										<div class="radio-inline">
											<label>
	...
	<div class="banner-perfil-dna">
		<div class="container">
			<div class="row" id="perfil-content">
				<div class="col-md-3" style="padding: 0">
					<div class="row">
						<div class="col-md-8 col-md-offset-2" id="div-thumbnail">
							<img src="dna/img/avatar.png" class="img-responsive img-thumbnail" alt="javier Bendezu">
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
						 <p class="txt-nome"><?php echo $_SESSION['usuario'];?> </p>
							<p class="txt-last-login">
								<i class="fal fa-sign-in" style="color: rgba(255, 255, 255, 0.5);"></i></p>
								<p style="color:white; font-size:30px;text-align:center;"> 
								<span id="hora" >5 Horas Gratis</span>
							</p> 
						</div>
					</div>
				</div>
				<div class="col-md-3">
					<div class="row">
						<div class="col-md-12">
							<p class="txt-banner-section center">Su progreso: </p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-10 col-md-offset-2 dashboard-progress">
							<div class="row">
								<div class="col-md-12">
									<i class="fas fa-id-card-alt icone-novos-conteudos"></i>
									<p class="num-dados-novos margin-dados job">0 </p>
									<p class="txt-dados margin-dados">Jobs aplicados</p>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<i class="fas fa-users icone-novos-conteudos"></i>
									<p class="num-dados-novos margin-dados headhunter">0 </p>
									<p class="txt-dados margin-dados">Headhunters contactados</p>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<i class="fas fa-street-view icone-novos-conteudos"></i>
									<p class="num-dados-novos margin-dados recruiter">0 </p>
									<p class="txt-dados margin-dados">Reclutadores contactados</p>
								</div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-1 hr-banner">
					<!-- procurar um jeito de melhorar isso, ta mto gambiarra, mas parece o melhor jeito de centralizar essa bagaça-->
					<table border=0 align=center width=3 height=335>
						<tr>
							<td bgcolor=red></td>
						</tr>
					</table>
				...
				<div class="col-md-5">
					<div class="row">
						<div class="col-md-12">
							<p class="txt-banner-section center">Novedades en IBjobcoach </p>
						</div>
					</div>
					<div class="row">
							...
							<div class="item banner col-md-12">
								<div class="row">
									...
									<div class="col-md-6 half-right">
										...
										<div class="row">
											<div class="col-md-12">
												<p class="num-title-novos left"> 1.486 </p>
