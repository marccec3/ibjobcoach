...
$consultatexto = "SELECT * FROM ibvirtuallicencias where correo = '$nombre_usuario1'";
$consultasql = $connect->prepare($consultatexto);
$consultasql->execute();

$pers = $consultasql->fetchALL(PDO::FETCH_ASSOC);

$conjunto = $persona->headhunters;
$hi = "lleno";

if(empty($conjunto)) 
{
    $hi = "vacio";
    $a = $consultasql->rowCount();
    foreach ($pers as $perso) { 
    $conjunto=$perso['headhunters'];
    }
}
...
$sql2 = "SELECT * FROM headhunters";
$query2 = $connect->prepare($sql2);
$query2->execute();


                                                $query = $connect->prepare("SELECT * FROM headhunters LIMIT $iniciar, $cantidadMostrar");
                                                $query->execute();
                                                $results = $query->fetchALL(PDO::FETCH_ASSOC);

$totalRespuestas=$query2->rowCount();

$nombrepagina="'Headhunters.php'";
                                                
$area="'#headhunters-content'";
...
?>                                                    
                                                <input type="hidden" class="hidden" value="25" id="headhunters-limit">
                                                <input type="hidden" class="hidden" value="30" id="headhunters-total">

                                                <?php if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) { ?>
                                                <div class="panel panel-default panel-headhunters">
                                                            ...
                                                            <div class="pull-left">
                                                                <form class="user_check" role="tablist">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox" value="headhunter" id="<?php echo $result['id']; ?>"
                                                    <?php 
                                                        $variable = explode('|',$conjunto);
                                                        foreach ($variable as $var) {
                                                    ...
                                                    ?>>
                                                            ...
                                                            <a role="button" data-toggle="collapse" data-parent="#headhunters-content" href="/#collapse-company-<?php echo $result['id']; ?>" aria-expanded="false" aria-controls="collapse-company-<?php echo $result['id']; ?>">
                                                    ...
                                                    <div id="collapse-company-<?php echo $result['id']; ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-company-<?php echo $result['id']; ?>">
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <?php 
                                                                $var=$result['id']; 
                                                                $query1 = $connect->prepare("SELECT * FROM detalle_headhunters where id_headhunter=$var");
                                                                $query1->execute();
                                                                    ...
                                                                    <table class="table table-striped table-bordered" style="margin-top: 1em;">
                                                                        ...
                                                                        <?php foreach ($results1 as $result1) { ?>
                                                                            <tr>
                                                                                ...
                                                                                <td><a href="cel:<?php echo $result1['celular']; ?>"><?php echo $result1['celular']; ?></td>
                                                                                <td>
                                                                                    <a href="mailto:<?php echo $result1['correo']; ?>"><?php echo $result1['correo']; ?></a>
                                                                                </td>
                                                                            </tr>
                                                                            <?php } ?>
                                                                        </tbody>
