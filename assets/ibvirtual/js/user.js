...
$('#forum-wrapper').on('click', '#thread-pagination .pagination a', function(event) {
	...
	$('#thread-list').empty().append('<img src="ibvirtual/img/loading-spinner-grey.gif" alt="' + _('Carregando') + '&hellip;"><p class="text-center">' + _('Carregando') + '&hellip;</p>');
...
$('#forum-wrapper').on('click', '.list-group-item-heading a', function(event) {
	...
	//var url = $(this).attr('href');
	//$('#message-list').empty().append('<img src="ibvirtual/img/loading-spinner-grey.gif" alt="' + _('Carregando') + '&hellip;"><p class="text-center">' + _('Carregando') + '&hellip;</p>');
	//url='mostrarRespuesta.php';
...
$('#perfilUsuario').on('submit',function(e){

	var $form = $(this);
	var imagen= document.getElementById('nombre_archivo').value;
	if(imagen == ""){
		e.preventDefault();
	}
	$.ajax({
