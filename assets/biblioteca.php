...
$sql1 = "SELECT * FROM contenidos where idcategoria=1";
$query2 = $connect->prepare($sql1);
$query2->execute();

        $sql = "SELECT * FROM contenidos where idcategoria=1 LIMIT $iniciar,$cantidadMostrar";
...
$nombrepagina="'biblioteca.php'";

$area="'#library-content'";
        ...
        <div class="panel panel-default panel-library">
            <div class=" panel-heading" role="tab" >
                ...
                <h4 class="panel-title">
                    <a role="button" data-toggle="collapse" data-parent="#library-content" href="/#<?php echo $result->idcontenido; ?>" aria-expanded="false" aria-controls="collapse-library-152"><?php echo $result->nombre; ?></a>
                </h4>
            </div>
            <div id="<?php echo $result->idcontenido; ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-library-152">
