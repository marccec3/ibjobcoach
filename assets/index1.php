                ...
                <div class="row">
                    <div class="col-md-12 text-center ">
                        <div class="row col-md-7 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-8 col-xs-offset-1 ">
                            ...
                            <div class="col-md-12">
                                <!--enlace--><a href="/#recruiters-tab" onclick="openNavArea('recruiters'); closeNav()" class="" aria-controls="recruiters-tab" role="tab" data-toggle="tab">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="valor-mercado-tab" data-dynamic="no">

                            <div class="row">
                                <div class="col-md-12">
                                    <p class="lead">Valor de Mercado</p>
                                </div>
                                <div class="col-md-12 text-center bg-warning">
                                    <div role="tabpanel" class="tab-pane fade active in" id="manual-tabs">
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <ul class="list-group list-user-files">
                                                                ...
                                                                <li class="list-group-item" style="text-align: left;">
                                                                    <i class="far fa-file"></i>
                                                                    <a href="dna/Valor de Mercado.pdf" download="ValorMercado">Valor de Mercado (PDF)</a>
                                                                </li>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="Templates-tab" data-dynamic="no">
                            <div class="row">
