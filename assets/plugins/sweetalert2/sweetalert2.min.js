!(function (e, t) {
  ...
  function n() {
    ...
    return new Promise(function (n, i) {
      function a(t, n) {
        for (var o = B(e.focusCancel), r = 0; r < o.length; r++) {
      ...
      function s(t) {
        ...
        if (-1 !== [9, 13, 32, 27].indexOf(r)) {
          ...
          9 === r
            ? (n.shiftKey ? a(c, -1) : a(c, 1), I(n))
            : 13 === r || 32 === r
            ? -1 === c && (e.focusCancel ? j(P, n) : j(b, n))
            : 27 === r &&
              e.allowEscapeKey === !0 &&
      ...
      e.reverseButtons
        ...
        : b.parentNode.insertBefore(b, P),
        (v.previousWindowKeyDown = window.onkeydown),
        (window.onkeydown = s),
        e.buttonsStyling &&
          ((b.style.borderLeftColor = e.confirmButtonColor),
          (b.style.borderRightColor = e.confirmButtonColor)),
        ...
        (o.hideLoading = o.disableLoading = function () {
          e.showConfirmButton || (T(b), e.showCancelButton || T(w())),
            L(b, "loading"),
            L(t, "loading"),
            (b.disabled = !1),
            (P.disabled = !1);
        ...
        (o.enableButtons = function () {
          (b.disabled = !1), (P.disabled = !1);
        }),
        (o.disableButtons = function () {
          (b.disabled = !0), (P.disabled = !0);
        }),
        ...
        (o.recalculateHeight = R(function () {
          var e = g(),
            t = e.style.display;
          (e.style.minHeight = ""),
            V(e),
        ...
        if ((H = c(N[d]))) {
          for (var K in H.attributes)
            if (H.attributes.hasOwnProperty(K)) {
              var U = H.attributes[K].name;
              "type" !== U && "value" !== U && H.removeAttribute(U);
            }
          for (var z in e.inputAttributes)
            H.setAttribute(z, e.inputAttributes[z]);
        }
        (D.className = W), e.inputClass && q(D, e.inputClass), T(D);
      }
      var Z;
      switch (e.input) {
        case "text":
        ...
        case "range":
          var F = M(t, l.range),
            J = F.querySelector("input"),
            $ = F.querySelector("output");
        ...
        case "radio":
          ...
          (X.innerHTML = ""),
            (Z = function (t) {
              ...
              V(X);
              var s = X.querySelectorAll("input");
              s.length && s[0].focus();
            });
          break;
        case "checkbox":
          var ee = M(t, l.checkbox),
            te = c("checkbox");
          (te.type = "checkbox"),
            (te.value = 1),
            (te.id = l.checkbox),
      ...
      ("select" !== e.input && "radio" !== e.input) ||
        ...
        Y(e.animation, e.onOpen),
        a(-1, 1),
        (r.scrollTop = 0),
        "undefined" == typeof MutationObserver ||
          p ||
          ((p = new MutationObserver(o.recalculateHeight)),
          p.observe(t, { childList: !0, characterData: !0, subtree: !0 }));
    });
  }
  function o() {
    var e = arguments;
    return o.isVisible() && o.close(), n.apply(this, e);
  }
  var r,
    i = "swal2-",
    a = function (e) {
  ...
  var p,
    ...
    g = function () {
      return document.body.querySelector("." + l.modal) || h();
    },
    b = function () {
      var e = g();
    ...
    C = function () {
      return y(l.progresssteps);
    },
    k = function () {
      return y(l.validationerror);
    },
    S = function () {
      return y(l.confirm);
    },
    ...
    Q = function (e) {
      ...
      var r = t.querySelector("h2"),
        i = t.querySelector("." + l.content),
        a = S(),
        u = x(),
        d = t.querySelector("." + l.close);
      r.innerHTML = e.title.split("\n").join("<br>");
      var p;
      if (e.text || e.html) {
        if ("object" == typeof e.html)
          if (((i.innerHTML = ""), 0 in e.html))
            for (p = 0; p in e.html; p++)
              i.appendChild(e.html[p].cloneNode(!0));
          else i.appendChild(e.html.cloneNode(!0));
        else i.innerHTML = e.html || e.text.split("\n").join("<br>");
        V(i);
      } else T(i);
      e.showCloseButton ? V(d) : T(d),
        (t.className = l.modal),
      ...
      e.progressSteps.length
        ? (V(f),
          ...
          e.progressSteps.forEach(function (t, n) {
            ...
            if (
              (q(o, l.progresscircle),
              (o.innerHTML = t),
              n === m && q(o, l.activeprogressstep),
              f.appendChild(o),
      ...
      if (e.type) {
        ...
        var k = t.querySelector("." + l.icon + "." + s[e.type]);
        switch ((V(k), e.type)) {
          case "success":
            q(k, "animate"),
              q(k.querySelector(".tip"), "animate-success-tip"),
              q(k.querySelector(".long"), "animate-success-long");
            break;
          case "error":
            q(k, "animate-error-icon"),
              q(k.querySelector(".x-mark"), "animate-x-mark");
            break;
          case "warning":
            q(k, "pulse-warning");
        }
      }
      var E = t.querySelector("." + l.image);
      e.imageUrl
        ? (E.setAttribute("src", e.imageUrl),
          V(E),
          e.imageWidth
            ? E.setAttribute("width", e.imageWidth)
            : E.removeAttribute("width"),
          e.imageHeight
            ? E.setAttribute("height", e.imageHeight)
            : E.removeAttribute("height"),
          (E.className = l.image),
          e.imageClass && q(E, e.imageClass))
        : T(E),
        e.showCancelButton ? (u.style.display = "inline-block") : T(u),
        e.showConfirmButton ? N(a, "display") : T(a);
      var B = w();
      e.showConfirmButton || e.showCancelButton ? V(B) : T(B),
        (a.innerHTML = e.confirmButtonText),
        (u.innerHTML = e.cancelButtonText),
        e.buttonsStyling &&
          ((a.style.backgroundColor = e.confirmButtonColor),
          (u.style.backgroundColor = e.cancelButtonColor)),
        (a.className = l.confirm),
        q(a, e.confirmButtonClass),
        (u.className = l.cancel),
        q(u, e.cancelButtonClass),
        e.buttonsStyling
          ? (q(a, "styled"), q(u, "styled"))
          : (L(a, "styled"),
            L(u, "styled"),
            ...
            (u.style.backgroundColor = u.style.borderLeftColor = u.style.borderRightColor =
              "")),
        e.animation === !0 ? L(t, "no-animation") : q(t, "no-animation");
    },
    Y = function (t, n) {
      var o = g();
      t ? (q(o, "show-swal2"), q(r, "fade"), L(o, "hide-swal2")) : L(o, "fade"),
        V(o),
        (r.style.overflowY = "hidden"),
        W && !P(o, "no-animation")
          ? o.addEventListener(W, function i() {
              o.removeEventListener(W, i), (r.style.overflowY = "auto");
            })
          : (r.style.overflowY = "auto"),
        q(r, "in"),
        q(document.body, l["in"]),
        e(),
  ...
  return (
    ...
    (o.queue = function (e) {
      ...
      var t = g(),
        n = function () {
          (z = []), t.removeAttribute("data-queue-step");
        };
    ...
    (o.deleteQueueStep = function (e) {
      "undefined" != typeof z[e] && z.splice(e, 1);
    }),
    (o.close = o.closeModal = function (e) {
      var n = g();
      L(n, "show-swal2"), q(n, "hide-swal2");
      var o = n.querySelector("." + l.icon + "." + s.success);
      L(o, "animate"),
        L(o.querySelector(".tip"), "animate-success-tip"),
        L(o.querySelector(".long"), "animate-success-long");
      var i = n.querySelector("." + l.icon + "." + s.error);
      L(i, "animate-error-icon"),
        L(i.querySelector(".x-mark"), "animate-x-mark");
      var a = n.querySelector("." + l.icon + "." + s.warning);
      L(a, "pulse-warning"),
        D(),
        W && !P(n, "no-animation")
          ? n.addEventListener(W, function c() {
              n.removeEventListener(W, c),
                P(n, "hide-swal2") &&
                  (T(n), L(r, "in"), L(document.body, l["in"]), t());
            })
          : (T(n), L(r, "in"), L(document.body, l["in"]), t()),
