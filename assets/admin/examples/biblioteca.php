      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">registro de Biblioteca</a>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Registar contenido</h4>
                  <p class="card-category">Complete todos los campos</p>
                </div>
                <div class="card-body">
                  <form action="?c=recibircontenido" method="POST">
                    <div class="row">
                      <div class="col-md-10">
                        <div class="form-group">
                        <input type="hidden" name="idcontenido" value="<?php echo $alu->idcontenido; ?>">
                       ...
                       <div class="col-md-6">
                          ...
                          <input type="text" name="nombre" class="form-control" placeholder="Ingrese el nombre de la página" required>
                       </div>
                       <div class="col-md-6">
                          <label for="categoria">Categoria</label>
                          <select class="form-control" name="categoria" required>
                            <option value="">Selecciona categoria</option>
                            <?php foreach ($this->valor->llenarcategoriacontenido() as $k) : ?>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="javascript:;">
                    <img class="img" src="../assets/img/faces/article.png" />
                  </a>
                </div>
                <div class="card-body">
                  <h6 class="card-category text-gray">URL/Contenidos</h6>
                  <h4 class="card-title">TODO LOS CONTENIDOS ANTIGUOS</h4>
                  <p class="card-description">
                    Aqui se registraran todo los contenidos antiguos de la web de guia
                  </p>
                </div>
              </div>
            </div>
