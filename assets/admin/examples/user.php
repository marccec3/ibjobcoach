            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Registar Alumni</h4>
                  <p class="card-category">Complete todos los campos</p>
                </div>
                <div class="card-body">
                  <form action="?c=recibiralumni" method="POST" enctype="multipart/form-data" autocomplete="off">
                   
                  <div class="row">       
                      <div class="col-md-5"> 
                        <input type="hidden" name="idalumni" value="<?php echo $alu->idalumni; ?>">
                        <label for="nombre">Nombre</label>
                        <input type="text" name="nombre" class="form-control" required>
                      </div>
                       <div class="col-md-4">
                          <label for="exampleInputFile">Adjuntar archivo</label>
                          <input type="file" name="foto" id="archivo-adjunto" required>
                       </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="javascript:;">
                    <img class="img" src="../assets/img/faces/alumni.png"/>
                  </a>
                </div>
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Se deben registrar todo los contenidos elavorados dentro de la empresa exclusivamente Usuarios  <i class="material-icons" style="color:red;">book</i>
                  </p>
