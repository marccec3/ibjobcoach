            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Registar foro</h4>
                  <p class="card-category">Complete todos los campos</p>
                </div>
                <div class="card-body">
                  <form action="?c=recibirforo" method="POST" enctype="multipart/form-data" autocomplete="off">
                   
                  <div class="row">       
                      <div class="col-md-5"> 
                        <input type="hidden" name="idforo" value="<?php echo $foro->idnombre; ?>">
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="javascript:;">
                    <img class="img" src="../assets/img/sidebar-3.jpg"/>
                  </a>
                </div>
                <div class="card-body">
                  <h6 class="card-category text-gray">IBOutplacement/foros</h6>
