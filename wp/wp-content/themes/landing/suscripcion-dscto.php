...
try {
    ...
    $mail->Password   = 'ADMINCORPIBGROUPV1';                               // SMTP password
   // $mail->SMTPSecure = 'tls';         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('cm.outplacement.coaching@corpibgroup.com', 'IB-Virtual');
    ...
    if ($type == "registro"){
        ...
        $body = '<b>Hola este esto es un correo de confirmacion</b> el correo que se ha registrado es: '.$email.' para confirmar su login haga aqui <a href="http://ibvirtual2.iboutplacement.com/assets/login.php">LOGIN IBJOBCOACH</a> <br>Recuerde poner el correo y la contraseña con la que se suscribio';
    }
